...
### 🐳메인화면(어항)
![fish tank](/docs/asset/어항영상.gif)
- 내가 잡은 물고기를 어항에 추가할 수 있음
- 동적인 물고기 움직임 구현

### 📖물고기 도감
![alt text](/docs/asset/도감.gif)
![alt text](/docs/asset/도감.png)
- 수집한 물고기 정보 저장 (어종 및 사진, 크기 환경 등)
- 수집한 물고기를 확인

### 🎣물고기종 분류 및 길이 측정
#### 물고기 분류
![길이측정](/docs/asset/길이측정%20영상.gif)
...
#### 데이터
![alt text](/docs/asset/data.png)
- 필터링 후 총 3228장의 이미지 학습

#### 길이측정
![alt text](/docs/asset/data_label.png)
- 데이터 라벨링 mask polygon 지정
![alt text](/docs/asset/mask.png)
![alt text](/docs/asset/mask2.png)
- Yolov8 Instance Segmentation을 이용해 윤곽 검출
![alt text](/docs/asset/길이측정픽셀.png)
- 물고기 길이 픽셀 측정
![alt text](/docs/asset/수식.png)
- AR기반 카메라와 물고기간 거리를 구해 실측거리 계산
- 가즘자 없는 Only Cam방식

#### OnDevice
![alt text](/docs/asset/QAT.png)
- 양자화 인지 학습 진행
![alt text](/docs/asset/TFLite.png)
- TFLite 변환


### 🚩낚시 포인트 정보 제공 (지도 형식)
![낚시포인트제공](/docs/asset/낚시포인트.gif)
![낚시포인트 환경제공](/docs/asset/낚시포인트환경.png)
- 포인트 별 물때, 날씨, 수온, 출몰 어종 등 낚시에 필요한 정보 제공
- 낚시 포인트 공유 기능
- 나만의 낚시포인트 저장(환경 정보 제공)

### 🤖챗봇
![chat bot](docs/asset/챗봇.gif)
- Open AI를 활용한 챗봇
- 낚시 컨셉에 맞게 프롬프트하여 제작
