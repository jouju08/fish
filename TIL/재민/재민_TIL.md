...
### **📖오늘 배운 내용**
오늘은 페이지 이동에서 거의 5시간30분 사용한것같다.
리엑트에서는 바텀바라는 컴포넌트를 고정시키고 페이지를 이동시키는데
플러터는 그게 안되는 것 같다.. 페이지를 이동시키면 바텀바가 중복으로 보이는
오류가 보인다. 결국 완전하게 해결을 하지 못했다.
오늘 역대급 스트레스 받았다
### **🧐 회고**
시간투자 더 더 많이 해야겠다. 컨디션 조절해야겠다.
앱 최적화를 먼저해야할지, 구현부터해야할지, 생각을좀 오래했지만,
항상 어느 앱이든 최적화는 후순위였던것같다. 구현부터 해야겠다.
### **🎯 내일 목표**
페이지 정상화 들어가야겠다.
<br><hr>
...
### **📖오늘 배운 내용**
오늘은 삽질만했다. 메인페이지파일이 17000자 라는
끔찍한 파일이 되어버려서 class 파일화 진행을했다.
왜 이렇게 진행하려하냐면, 앞으로 더 많이 생길 페이지들이
너무 많아져, 리엑트처럼 컴포넌트화 시키려하는거다.
코드 분해를 하다보니,, 물고기 수영로직이 망가져서
삽질만하다 끝났다.
### **🧐 회고**
작업하는 방식이 뭔가 잘못됐다.
나만의 방식을 가지는 것이 중요할 것 같다.
### **🎯 내일 목표**
오늘 새벽까지 최대한 해야겠다,,평가가 있기때문에,
우선 오늘 쥐어짤대로 쥐어짜보고 내일 평가 무사히
끝내길, 내일은 백단과 연결 해보겠다.
<br><hr>

## 📅2025-03-28
병원 이슈로 사유결석입니다. 참석하지못해 죄송합니다.
<br><hr>

## 📅2025-03-31

### **📖오늘 배운 내용**
지금 32시간 무호흡 코딩한 상태이다.
물고기 수영로직을 크게 변경했으며,
추가, 삭제, 피그마에서 만든대로 그대로
구현 완료했다. 저번주 목요일날 삽질만 하다 끝나서
분해서 23시간 무호흡 코딩을 하고 나니, 완성이돼서
속이 다 시원해졌다. 오늘은 회원가입api , 로그인 api , 회원정보 api 연결 성공했다.
### **🧐 회고**
뭔가 개발하는 방식을 바꿔야할 필요가있다.
왜냐하면 나는 소통을 피하려하는 경향이 있다.
혼자서 해결해서 최대한 다른팀원들의 추가업무(수정 등)를
주지 않으려 혼자 해결하려하니, 이런 32시간 무호흡 코딩하는 사태가
벌어진 것 같다. 뭔가,, 컨설턴트님과 상담을 한번 해봐야겠다.
### **🎯 내일 목표**
내일은 마무리! api
<br><hr>
...
### **📖오늘 배운 내용**
오늘은 새벽2시에 끝내고 TIL 쓰고자려고했으나
어떨결에 06시39분이 되었다.
오늘은 방문자수와 좋아요수 api 연결작업과
방명록 레이아웃 작업을 했다.
상태관리에대해 디테일적으로 배운 날이였다.
### **🧐 회고**
개발방식을 정말 바꾸고싶다.
싸피 하는동안만 이런생활 해야겠다.
### **🎯 내일 목표**
오늘(2일) 목표는
랭킹과 방명록 완성 + 물고기 서버에 연결해서
수족관에 보이는 정보들을 저장하는 작업을 할 것이다.
되면 마이페이지까지
<br><hr>
...
### **📖오늘 배운 내용**
오늘은 ranking_provider 파일을 작업했다.
확실히,, 백앤드와 연동이 제일 여러운 것 같다.
### **🧐 회고**
뭔가 사용자 편의성을 굉장히 높히고싶은 욕심이 있다. (시간이 별로 없지만,,)
요즘은 앱 메타가 편의성싸움같은 느낌이 물씬 든다.
편하면 사용자가 리스크를 감수하면서까지 사용하는 느낌적인 느낌..?
### **🎯 내일 목표**
내일은 유저 검색에 도전해보겠다.
추가로 방명록 작성까지,,!!
그리고 시간이 나면 물고기 5번 터치해서 이스터에그형식으로
미니게임 만들고 싶다.
시간만된다면, 먹이버튼 만들어서 누르면 먹이 먹으러 달려드는거(먹으면커짐)
까지 구현하고싶다.
그리고 드래그앤드롭 만들고싶다. 시간만 된다면,
<br><hr>

## 📅2025-04-04

### **📖오늘 배운 내용**
오늘은 ranking provider 코드 작업을했다.
dart 문법 국건이에게 물어봐서 조언을 얻었다.
(사실 gpt 한테 물어보면 되긴하는데)
### **🧐 회고**
주말에 아주 완벽히. 해내는게 목표이다.
할 수 있다. 근데 여전히 개발하는 방식을 좀 바꾸고싶다 ㅠ
컨설턴트님께 조언을 구해봐야겠다.
### **🎯 내일 목표**
주말에 다끝낸다.
<br><hr>
